...
Start a server listening on port 8488 using `DarkStar` AEAD cipher with private key `dd5e9e88d13e66017eb2087b128c1009539d446208f86173e30409a898ada148`.

```sh
go-shadowsocks2 -s 'ss://DarkStar:dd5e9e88d13e66017eb2087b128c1009539d446208f86173e30409a898ada148@:8488' -verbose
```
...
```sh
go-shadowsocks2 -c 'ss://DarkStar:d089c225ef8cda8d477a586f062b31a756270124d94944e458edf1a9e1e41ed6@[server_address]:8488' \
...
```sh
go-shadowsocks2 -c 'ss://DarkStar:d089c225ef8cda8d477a586f062b31a756270124d94944e458edf1a9e1e41ed6@[server_address]:8488' -redir :1082 -redir6 :1083
```
...
```sh
go-shadowsocks2 -c 'ss://DarkStar:d089c225ef8cda8d477a586f062b31a756270124d94944e458edf1a9e1e41ed6@[server_address]:8488' -tcptun :1090=localhost:5201
```
